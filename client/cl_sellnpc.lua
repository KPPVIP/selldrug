...
Selldrugs.Items = {
	{item = "weed", label = "weed", props = "prop_weed_block_01", anim = {"mp_common", "givetake2_a"}, minmoney = 90, maxmoney = 100},
	{item = "cocaine", label = "cocaine", props = "prop_coke_block_half_b", anim = {"mp_common", "givetake2_a"}, minmoney = 100, maxmoney = 110},
	{item = "meth", label = "meth", props = "p_meth_bag_01_s", anim = {"mp_common", "givetake2_a"}, minmoney = 110, maxmoney = 120},
}
